...
#         base_lm: GPT2LMHeadModel = GPT2LMHeadModel.from_pretrained(config.lm)  # type: ignore
        base_lm: GPT2LMHeadModel = GPT2LMHeadModel.from_pretrained("")  # type: ignore
...
#         base_lm: OPTForCausalLM = OPTForCausalLM.from_pretrained(config.lm)  # type: ignore
        base_lm: OPTForCausalLM = OPTForCausalLM.from_pretrained("/kaggle/input/opt-13b/")  # type: ignore
